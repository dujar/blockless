  ...
  return (
    <div className="text-center">
      <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 dark:text-white leading-tight">
        ...
        <br />
        <span className="text-blue-500">Simply and Securely.</span>
      </h1>
      ...
      <div className="mt-8 flex justify-center gap-4">
        ...
        <Link
          to="/create-order"
          className="bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 px-8 py-3 rounded-lg font-medium text-lg transition"
        >
          Create an Order
        </Link>
      </div>
      ...
      <div className="mt-24 max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10 text-left">
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
            <div className="flex-shrink-0 h-12 w-12 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mb-6">
          ...
          {/* Step 3 */}
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg relative flex flex-col justify-between">
            <div>
              <div className="flex-shrink-0 h-12 w-12 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mb-6">
            ...
            <div className="mt-6 flex items-center justify-end text-gray-500 dark:text-gray-400 text-sm">
