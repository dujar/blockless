...
const LandingPage = () => {
  return (
    <div className="text-center">
      <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-base-content leading-tight">
        Accept Crypto Payments,
        <br />
        <span className="text-neutral-content">Simply and Securely.</span>
      </h1>
      <p className="mt-6 max-w-2xl mx-auto text-lg text-neutral-content">
      ...
      <div className="mt-24 max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold text-base-content mb-12">How It Works in 3 Simple Steps</h2>
        <div className="grid md:grid-cols-3 gap-10 text-left">
          ...
          <div className="bg-base-100 p-8 rounded-2xl shadow-lg shadow-dynamic">
            <div className="flex-shrink-0 h-12 w-12 rounded-full bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center mb-6">
              <span className="text-neutral-content text-2xl font-bold">1</span>
            </div>
            <h3 className="text-xl font-semibold text-base-content mb-3">Register Your Profile</h3>
          ...
          <div className="bg-base-100 p-8 rounded-2xl shadow-lg shadow-dynamic">
            <div className="flex-shrink-0 h-12 w-12 rounded-full bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center mb-6">
              <span className="text-neutral-content text-2xl font-bold">2</span>
            </div>
            <h3 className="text-xl font-semibold text-base-content mb-3">Create an Order</h3>
            <p className="text-neutral-content">
          ...
          {/* Step 3 */}
          <div className="bg-base-100 p-8 rounded-2xl shadow-lg shadow-dynamic relative flex flex-col justify-between">
            <div>
              <div className="flex-shrink-0 h-12 w-12 rounded-full bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center mb-6">
                <span className="text-neutral-content text-2xl font-bold">3</span>
              </div>
              <h3 className="text-xl font-semibold text-base-content mb-3">Get Paid</h3>
              <p className="text-neutral-content">
            ...
            <div className="mt-6 flex items-center justify-end text-neutral-content text-sm">
      ...
      <div className="mt-24">
        ...
        <WalletMarquee />
        <p className="mt-8 text-neutral-content">
