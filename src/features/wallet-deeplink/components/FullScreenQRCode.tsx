        ...
        >
            <div className="bg-white dark:bg-primary-950 rounded-lg shadow-lg p-6 w-full max-w-md" onClick={e => e.stopPropagation()}>
                <div className="text-center mb-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-primary-400 mt-2">
                ...
                <div className="text-center space-y-2 text-gray-800 dark:text-primary-300 text-sm">
                ...
                <div className="mt-4 p-3 bg-gray-100 dark:bg-primary-900 rounded-lg group w-full">
                    ...
                    <div className="flex justify-center items-center space-x-4 mt-3">
                        <a href={socialDeeplinkShareLinks.twitter} target="_blank" rel="noopener noreferrer" title="Share on Twitter" className="text-gray-600 hover:text-blue-500 dark:text-primary-400 dark:hover:text-blue-400">
                        ...
                        <a href={socialDeeplinkShareLinks.telegram} target="_blank" rel="noopener noreferrer" title="Share on Telegram" className="text-gray-600 hover:text-blue-600 dark:text-primary-400 dark:hover:text-blue-500">
                        ...
                        <a href={socialDeeplinkShareLinks.whatsapp} target="_blank" rel="noopener noreferrer" title="Share on WhatsApp" className="text-gray-600 hover:text-green-600 dark:text-primary-400 dark:hover:text-primary-500">
