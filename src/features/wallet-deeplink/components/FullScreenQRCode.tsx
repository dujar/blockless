            ...
            <div className="bg-base-100 rounded-lg shadow-lg p-6" onClick={e => e.stopPropagation()}>
                ...
                <div className="mt-4 p-3 bg-base-300 dark:bg-primary-900 rounded-lg group w-full">
                    ...
                    <div className="flex justify-center items-center space-x-4 mt-3">
                        <a href={socialDeeplinkShareLinks.twitter} target="_blank" rel="noopener noreferrer" title="Share on Twitter" className="text-neutral-content hover:text-info-content">
