...
export const FullScreenQRCode = ({ wallet, blockchainName, tokenSymbol, amount, recipientAddress, fiatAmount, fiatCurrency, onClose }: FullScreenQRCodeProps) => {
    ...
    return (
        ...
        >
            <div className="bg-white dark:bg-primary-950 rounded-lg shadow-lg p-6 w-full max-w-md" onClick={e => e.stopPropagation()}>
                ...
                <div className="mt-4 p-3 bg-gray-100 dark:bg-primary-900 rounded-lg group w-full">
                    ...
                    <div className="flex justify-center items-center space-x-4 mt-3">
                        ...
                        <a href={socialDeeplinkShareLinks.whatsapp} target="_blank" rel="noopener noreferrer" title="Share on WhatsApp" className="text-gray-600 hover:text-green-600 dark:text-gray-400 dark:hover:text-gray-500">
            ...
            <button
                onClick={onClose}
                className="mt-6 px-4 py-2 text-gray-500 hover:text-gray-700 dark:hover:text-gray-400"
            >
                ← Close
            </button>
        </div>
