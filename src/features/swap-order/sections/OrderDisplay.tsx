...
const QRCodeDisplay = ({ qrCodeUrl, formData, quoteData, isQuoteLoading, quoteError, onBackToForm }: QRCodeDisplayProps) => {
    ...
    return (
        <div className="p-6">
            ...
            {isQuoteLoading && <div className="text-center text-primary-500 p-4">Loading quote...</div>}
                        ...
                        <div className="p-3 bg-primary-50 dark:bg-primary-900/20 group w-full rounded-b-xl">
                            <div className="flex justify-between items-center text-sm font-medium text-primary-700 dark:text-primary-300 mb-1">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <button onClick={() => handleOpenLink(qrCodeUrl)} className="p-1 rounded-md text-primary-600 dark:text-primary-400 hover:bg-primary-100 dark:hover:bg-primary-800 transition" title="Open in browser">
