        ...
        return (
            <div className="flex items-center text-gray-900 dark:text-white text-xl font-bold">
                ...
                <div className="flex ml-2 space-x-1">
                    ...
                    {uniqueTokens.size > 3 && <span className="text-base text-gray-700 dark:text-primary-400"> +{uniqueTokens.size - 3} more</span>}
                </div>
            </div>
        );
    };
        ...
        <div className={isFullScreenQR ? 'fixed inset-0 z-50 bg-white dark:bg-primary-950 p-4 flex flex-col justify-between' : ''} onClick={() => isFullScreenQR && setIsFullScreenQR(false)}>
            ...
            <div className={`flex flex-col ${isFullScreenQR ? 'flex-grow justify-center' : 'space-y-8'}`} onClick={(e) => e.stopPropagation()}>
                <div>
                    ...
                    <p className="text-gray-700 dark:text-primary-400 mb-2">Scan this QR code to open the Blockless swap page, powered by 1inch Fusion+.</p>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6 mb-8">
                        ...
                        <div className="flex flex-col items-center">
                            <h4 className="text-lg font-medium text-gray-800 dark:text-primary-200 mb-2">Blockless Link</h4>
                            <div
                            ...
                            <div className="mt-2 text-gray-600 dark:text-primary-400 text-sm">
                                via Blockless
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            <h4 className="text-lg font-medium text-gray-800 dark:text-primary-200 mb-2">1inch Fusion+ Link</h4>
                            <div
                                className="p-2 bg-white rounded-lg border-4 border-primary-500 cursor-pointer"
                                onClick={() => setIsFullScreenQR(true)}
                            >
                    ...
                    <div className="mt-4 p-3 bg-gray-100 dark:bg-primary-900 rounded-lg group w-full">
                        <div className="flex justify-between items-center text-sm font-medium text-gray-800 dark:text-primary-300 mb-1">
                            <span>Shareable Link</span>
                            <div className="flex items-center space-x-2">
                                <button
                                    type="button"
                                    onClick={() => copyToClipboard(shareUrl)}
                                    className="p-1 rounded-md text-gray-600 dark:text-primary-400 hover:bg-gray-200 dark:hover:bg-primary-800 transition"
                                    title="Copy link"
                                >
                                    {copiedLink ? (
                        ...
                        <div className="text-xs font-mono break-all text-gray-700 dark:text-primary-200 bg-gray-200 dark:bg-primary-800/50 p-2 rounded">
                            <a href={shareUrl} target="_blank" rel="noopener noreferrer" className="hover:underline">
                                {shareUrl}
                            </a>
                        </div>
                        <div className="flex justify-center items-center space-x-4 mt-3">
                            <a href={socialShareLinks.twitter} target="_blank" rel="noopener noreferrer" title="Share on Twitter" className="text-gray-600 hover:text-blue-500 dark:text-primary-400 dark:hover:text-primary-400">
                            ...
                            <a href={socialShareLinks.telegram} target="_blank" rel="noopener noreferrer" title="Share on Telegram" className="text-gray-600 hover:text-blue-600 dark:text-primary-400 dark:hover:text-primary-500">
                            ...
                            <a href={socialShareLinks.whatsapp} target="_blank" rel="noopener noreferrer" title="Share on WhatsApp" className="text-gray-600 hover:text-green-600 dark:text-primary-400 dark:hover:text-primary-500">
            ...
            <div className={`flex ${isFullScreenQR ? 'mt-auto justify-center' : 'mt-6 justify-center'}`}>
                <button onClick={isFullScreenQR ? () => setIsFullScreenQR(false) : onBackToOrderDetails} className="px-4 py-2 text-primary-500 hover:text-primary-700 dark:hover:text-primary-400" >
