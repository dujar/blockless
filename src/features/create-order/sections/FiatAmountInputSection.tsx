...
const FiatAmountInputSection = ({ form }: FiatAmountInputProps) => {
    ...
    return (
        <div className="bg-white dark:bg-primary-950 p-8 rounded-2xl shadow-lg shadow-dynamic">
            ...
            <p className="text-lg text-gray-700 dark:text-primary-300 mb-6">
                Enter the desired amount in your preferred fiat currency.
            </p>
            <div className="mb-8">
                <label htmlFor="fiat-amount-input" className="block text-sm font-medium text-gray-800 dark:text-primary-300 mb-2">
                    Order Amount
                </label>
                <div className="relative rounded-lg shadow-sm flex items-center bg-white dark:bg-primary-900 ring-1 ring-inset ring-gray-300 dark:ring-primary-800 focus-within:ring-2 focus-within:ring-primary-600">
                    <div className="flex items-center pl-3 pr-2">
                        ...
                        <span className="text-gray-700 dark:text-primary-300 font-semibold text-base">
                    ...
                    <div className="flex items-center pr-3">
                        <span className="text-gray-500 dark:text-primary-400 text-sm font-medium">
